...
Creating or deleting a group creates or deletes the matching proxy in `bin`. The GUI appends `bin`
to the user PATH. Existing terminals must be reopened after the first launch.
